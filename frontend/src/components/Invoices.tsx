    ...
    <div className='flex flex-col items-center justify-center'>
      ...
      {isInvoiceFormOpen && (
        <InvoiceForm
          ...
          // @ts-expect-error type is correctly set
              ...
              <>
                ...
                >
                  <div className='lg:w-1/3 md:w-full px-8 py-6 border-opacity-60'>
                    <div>
                      <h2 className='text-lg text-gray-900 font-medium mb-1'>
                        Issued:
                      </h2>
                  ...
                  <div className='lg:w-1/3 md:w-full px-8 py-6 border-l-2 border-gray-200 border-opacity-60'>
                    ...
                    <div className=''>
                      <h2 className=' text-gray-900 text-base mb-1 font-medium'>
                        Recipient&apos;s Email
                      </h2>
                ...
                <div className='flex flex-row justify-between w-full mt-1'>
                  <div>
                    <button
                      className='bg-blue-500 px-2 py-2 rounded text-white hover:bg-blue-600'
